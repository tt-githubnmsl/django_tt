...
urlpatterns = [
    ...
    path('unwritten/', views.unwritten, name='unwritten_block'),
    path('goodfriends/', views.friends, name='good_friends'),
    path('redtee/', views.drink, name='drink_tea'),
    path('shicken/', views.schicken, name='schicken'),
