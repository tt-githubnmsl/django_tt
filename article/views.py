...
def schicken(request):
    return render(request, 'shicken.html')

def drink(request):
    return render(request, 'redtee.html')

def unwritten(request):
    return render(request, 'unwritten.html')

def friends(request):
    return render(request, 'goodfriends.html')
